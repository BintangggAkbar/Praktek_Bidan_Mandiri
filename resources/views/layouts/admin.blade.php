...
<body class="font-sans antialiased bg-gray-50 text-slate-800">
    <div x-data="{ sidebarOpen: false, profileOpen: false }" class="min-h-screen flex flex-col md:flex-row relative">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1 px-2">
                    ...
                    <!-- Backup Database -->
                    <li>
                        <a href="{{ route('admin.backup.download') }}" @click="sidebarOpen = false"
                            class="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white"
                            onclick="return confirm('Apakah Anda yakin ingin mengunduh backup database?')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        <button @click="profileOpen = !profileOpen"
                            class="h-10 w-10 rounded-full bg-slate-800 flex items-center justify-center text-white font-bold border border-slate-600 hover:ring-2 hover:ring-slate-400 transition-all cursor-pointer">
